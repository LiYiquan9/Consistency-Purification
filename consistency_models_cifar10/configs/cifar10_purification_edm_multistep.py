...
from consistency_models_cifar10.configs.default_cifar10_configs import get_default_configs
...
def get_config():
    ...
    sampling.method = "edm_onestep_purification" # edm_onestep_purification
